...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["081617620966"] // replace with your whatsapp number
	    ...
	    if (isMedia) {
                try {
                    ...
                    var result = await removeBackgroundFromImageBase64({ base64img, apiKey: 'LEUJU9ybLwAHbLqnGShv', size: 'auto', type: 'auto', outFile })
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/6281617620966', id)
